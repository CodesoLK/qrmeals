    ...
    <section class="section pt-lg-0" id="restaurant-content" style="padding-top: 0px">
        ...
        <nav class="tabbable sticky" style="top: <?php echo e(config('app.isqrsaas') ? 64:88); ?>px;">
            ...
            <?php $__currentLoopData = $restorant->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
                <?php if(!$category->aitems->isEmpty()): ?>
                <div id="<?php echo e($categ_id); ?>" class="<?php echo e(clean(str_replace(' ', '', strtolower($category->name)).strval($key))); ?>">
                    <h1><?php echo e($category->name); ?></h1><br />
                </div>
                <?php endif; ?>
                <div class="row <?php echo e(clean(str_replace(' ', '', strtolower($category->name)).strval($key))); ?> append_<?php echo e(clean(str_replace(' ', '', strtolower($category->name)).strval($key))); ?>">
...
<?php $__env->startSection('js'); ?>
    <script>
        ...
        function enterCategory(id_categ, section)
        {
            ...
            $.ajax({
                type:'POST',
                url:"<?php echo e(route('restaurant.ajax')); ?>",
                data:{
                    id:id_categ,
                    categ_id:section
                },
...
<?php if(isset($showGoogleTranslate)&&$showGoogleTranslate&&!$showLanguagesSelector): ?>
    ...
    <?php $__env->stopSection(); ?>
<?php endif; ?>
<?php echo $__env->make('layouts.front', ['class' => ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\resources\views/restorants/show.blade.php ENDPATH**/ ?>