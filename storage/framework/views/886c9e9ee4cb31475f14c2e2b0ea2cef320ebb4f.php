                            ...
                            <div class="col-lg-12">
                                <div class="row row-grid">
                                    ...
                                    <?php $__currentLoopData = $category->subcategorys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-lg-3">
                                                <a href="javascript:void(0);" onclick="getCategory(<?php echo e($subcategory->id); ?>, <?php echo e($category->id); ?>)">
                                                    <div class="card">
...
function getCategory(id_category, idparent) {
    ...
    $.ajax({
           type:'POST',
           url:"<?php echo e(route('subcategory.get')); ?>",
           data:{id:id_category},
           dataType: 'HTML',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', ['title' => __('Restaurant Menu Management')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\resources\views/items/index.blade.php ENDPATH**/ ?>